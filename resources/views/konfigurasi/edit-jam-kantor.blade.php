<form action="{{ url('setting/jam/update/' . $jam_kerja->kode_jam_kerja) }}" method="POST" id="form-addJk">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ $jam_kerja->kode_jam_kerja }}" id="kode_jam_kerja" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ $jam_kerja->akhir_jam_masuk }}" id="akhir_jam_masuk" class="form-control"
