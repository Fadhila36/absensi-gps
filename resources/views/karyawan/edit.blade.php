    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" disabled value="{{ $karyawan->nik }}" id="nik" class="form-control"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="number" value="{{ $karyawan->no_hp }}" id="no_hp" class="form-control" name="no_hp"
        ...
        <div class="col-12">
            <select name="kode_cabang" id="kode_cabang" class="form-select">
                ...
                @foreach ($cabang as $item)
                    <option {{ $karyawan->kode_cabang == $item->kode_cabang ? 'selected' : '' }}
