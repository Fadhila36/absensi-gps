...
<head>
    ...
    <title>Dashboard - Administrator Absensi.</title>
    <!-- CSS files -->
...
<body>
    ...
    <script src="{{ asset('tabler/dist/js/sweetalert2.js') }}" defer></script>
    <script src="{{ asset('tabler/dist/js/jquery.mask.min.js') }}" defer></script>
